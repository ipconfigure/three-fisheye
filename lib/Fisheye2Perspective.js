    ...
    var Fisheye2Perspective = /** @class */ (function (_super) {
        ...
        function Fisheye2Perspective(o) {
            ...
            if (o != null && o.orientation !== null && o.orientation !== undefined) {
                _this.orientation = o.orientation;
            }
            else {
                _this.orientation = 'ceiling';
            }
        ...
        Object.defineProperty(Fisheye2Perspective.prototype, "orientation", {
            get: function () {
    ...
    function createFisheyeMesh(fisheye_texture, MESH_N) {
        ...
        faces.forEach(function (face, i) {
            ...
            faceVertexUvs[0][i] = [a, b, c].map(function (id) {
                ...
                a, b, r, // radius of vector defined by x,y,z going through the origin piont in the lens
